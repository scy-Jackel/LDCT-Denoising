...
import math
from metric.metric_util import abs, real, imag, downsample
...
class FSIM(torch.nn.Module):
    ...
    def __init__(self, channels=3, as_loss=True):
...
if __name__ == '__main__':
    ...
    import argparse
    from metric.metric_util import prepare_image
